...
def question_panel(request):
    ...
    if request.user.is_authenticated:
        ...
        dict={'t':timer(), 'a0': percentage_accuracy[0], 'a1': percentage_accuracy[1], 'a2': percentage_accuracy[2], 'a3': percentage_accuracy[3], 'a4': percentage_accuracy[4], 'a5': percentage_accuracy[5], 'subs0': subs[0], 'subs1': subs[1], 'subs2': subs[2], 'subs3': subs[3], 'subs4': subs[4], 'subs5': subs[5],'qtitle0':qtitle[0],'qtitle1':qtitle[1],'qtitle2':qtitle[2],'qtitle3':qtitle[3],'qtitle4':qtitle[4],'qtitle5':qtitle[5]}
